...
<div class="section pre_project_block"></div><!-- the image above ground -->
...
$bg_image = wp_get_attachment_image_src( get_post_thumbnail_id( $projects->ID ), 'project' );

if($post_num == 1 | $post_num % 2 != 0){
$extra_classes = 'firstcolumn';
echo '<div class="project_row">';
}

elseif ($post_num == 2 | $post_num % 2 == 0) {
...
if( $total_posts % 2 != 0 ){
echo '</div><!--close the project row when $total_posts % 2 != 0 -->';
}
wp_reset_query();
?>
</div>
